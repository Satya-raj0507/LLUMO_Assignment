        ...
        for item in log_entry.get("items", []):
            ...
            for i in inputs:
                if i.get("role") == "user":
                    ...
                    # Using the raw system prompt directly as context, per request.
...
def main():
    ...
    """
    # Choose the LLM provider based on environment variable
    ...
    for item in parsed_data:
        # This prompt asks the LLM to act as the evaluator and return scores in a JSON format.
        prompt = f"""
        ...
        try:
            ...
            # If there's an error, scores will remain None
